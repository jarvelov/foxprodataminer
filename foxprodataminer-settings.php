...
class foxpro_data_miner_settings {
    ...
    function render_doc_text($args) {
		?>
			...
			<div class="fdm-documentation" id="introduction"><h3>Introduction</h3>Configure the name and path of your database as well as the columns (comma separated) you want to cache.</div>
